...
**E012 is decided (REFUTED, 2026-09-04): the ceiling has no captured key.** E011's +$5.79/day LINK/WETH 0.30% ceiling (K16) stands, but no pre-named trailing-vol gate captures it — best cell +$0.577/day vs the +$0.915/day static bar, every August negative, 0/120 tune configs beat same-arm always-in (K17: the bursts are faster than causal trailing vol; the fast signal that does select fragments unaffordably). **The loop is stopped on PROTOCOL §7: the three-way venue call is the operator's**, now fully briefed — carry validated (E009, compressing), fee-edge ceiling real but unrealized (E011 + E012), K8/T1 margin design (bot PR #32) prerequisite to the carry path. B2 stays HELD; capital stays parked (bot ADR 0008). No new experiment should target the K16 ceiling without a structurally new causal family (see K17 and E012 §What-this-changes).
