...
- **H-timing** — regime/timing policies on a fixed venue: the family-internal escape E003 §8 left open. E006 measures the perfect-foresight ceiling on ETH/USDC 0.05%; E007 (staged, unwritten) tests causal signals (Kaufman ER, realized vol) only if the ceiling justifies it. Operator prior (2026-09-02): low-vol sideways regimes should favor LP; the crux is regime persistence, which E006 measures descriptively.
