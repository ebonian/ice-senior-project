...
- **From:** [E011](../loop/experiments/E011-link-ceiling.md) §5 (trailing signals separate inverted: prev-1h RV AUC 0.85 as skip) + §2 (daily grain retains 78% of +$5.79/day); memo [M006](memos/M006-vol-gated-capture-of-the-link-ceiling.md) (this card's candidate set).
- **Correction (M006 §2, from the committed mask):** the skip episodes are NOT multi-day — they are 13 bursts of 1–18h (median 5h, 87h total) clustered inside loud weeks; what is multi-day is the *held streaks*. The gate's job is burst-dodging with re-entry between bursts. And 81% of the dodgeable stage-1 damage (−$840 of −$1,034) sits in held-out August — the capture test is out-of-sample by construction.
- **Why it might work:** the burst signal separates at quartile level causally (prev-1h swap-RV held p75 < skipped p25, 6.1× at p50); the −$11.9/h skipped vs +$0.95/h held asymmetry means even a late gate keeps most of its value; grain-4h + hysteresis makes E007's fragmentation structurally hard to recreate (the oracle itself pays only ~13 round trips ≈ $1.39/day).
- **Why it might not:** E007/E008's ghost — selection quality without capture; August's bursts must be dodged *causally* and trailing vol reacts after the first (worst) hours; the pessimistic envelope already eats the ceiling (−$13.51/day).
- **Status:** **E012 RUNNING** (operator go 2026-09-03; memo M006 committed 2026-09-04; prereg [E012](../loop/experiments/E012-vol-gate-capture.md)).
